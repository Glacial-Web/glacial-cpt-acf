...
function doctor_post_type_register() {
	...
	$doctors_single_name = rtrim( $doctors_cpt_name, 's' );

	$labels = array(
		'name'          => $doctors_cpt_name,
		'singular_name' => $doctors_single_name,
		'menu_name'     => $doctors_cpt_name,
		'all_items'     => 'All ' . $doctors_cpt_name,
		'view_item'     => 'View ' . $doctors_single_name,
		'add_new_item'  => 'Add New ' . $doctors_single_name,
		'add_new'       => 'Add New ' . $doctors_single_name,
		'edit_item'     => 'Edit ' . $doctors_single_name,
		'update_item'   => 'Update ' . $doctors_single_name,
...
function location_post_type_register() {
	...
	$locations_single_name = rtrim( $locations_cpt_name, 's' );

	$labels = array(
		'name'          => $locations_cpt_name,
		'singular_name' => $locations_single_name,
		'menu_name'     => $locations_cpt_name,
		'all_items'     => 'All ' . $locations_cpt_name,
		'view_item'     => 'View ' . $locations_single_name,
		'add_new_item'  => 'Add New ' . $locations_single_name,
		'add_new'       => 'Add New ' . $locations_single_name,
		'edit_item'     => 'Edit ' . $locations_single_name,
		'update_item'   => 'Update ' . $locations_single_name,
